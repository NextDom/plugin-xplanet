...
sendVarToJS('eqType', 'xplanet');
$eqLogics = eqLogic::byType('xplanet');
?>
...
foreach ($eqLogics as $eqLogic) {
	...
	echo "<center>";
	echo '<img src="plugins/xplanet/doc/images/xplanet_icon.png" height="105" width="95" />';
	echo "</center>";
  ...
  <form class="form-horizontal">
    <fieldset>
      ...
      <div class="form-group">
        <label class="col-sm-3 control-label">{{Nom de l'équipement xplanet}}</label>
        <div class="col-sm-3">
          <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
          <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement xplanet}}"/>
        </div>
      </div>
      <div class="form-group">
    ...
    <form class="form-horizontal">
        <fieldset>
            <legend>{{Paramètres}}</legend>
					...
					<div class="form-group">
					  <label class="col-sm-3 control-label">{{Résolution}}</label> (640x480 ou 1280x720 ...)
					  <div class="col-sm-3">
					    <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="size"/>
					  </div>
					</div>
					<div class="form-group">
...
<?php include_file('desktop', 'xplanet', 'js', 'xplanet');?>
...
<script>
	...
	$("#bt_refreshCapture").click(function(){
			var text = $("#cameraPath_url").text();
			document.capture_visu.src="plugins/xplanet/doc/images/xplanet_icon.png";
	...
	$("#bt_serviceStatus").click(function(){
			...
			$('#md_modal').load('index.php?v=d&plugin=xplanet&modal=status.xplanet').dialog('open');
  });
</script>

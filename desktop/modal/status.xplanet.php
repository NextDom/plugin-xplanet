...
?>
<div id='div_statusxplanetAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_xplanetstatus' style='overflow: auto; height: 90%;with:90%;'></pre>
...
<script>
	$.ajax({
		...
		data: {
			action: 'statusxplanet',
			serviceName: $("#serviceName").text()
		},
		dataType: 'json',
		global: false,
		error: function (request, status, error) {
			handleAjaxError(request, status, error, $('#div_statusxplanetAlert'));
		},
		success: function () {
			 jeedom.log.autoupdate({
			       log : 'xplanet_status',
			       display : $('#pre_xplanetstatus'),

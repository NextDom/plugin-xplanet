...
?>
<div id='div_resetxplanetAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_xplanetreset' style='overflow: auto; height: 90%;with:90%;'></pre>
...
<script>
	$.ajax({
		...
		error: function (request, status, error) {
			handleAjaxError(request, status, error, $('#div_resetxplanetAlert'));
		},
		success: function () {
			 jeedom.log.autoupdate({
			       log : 'xplanet_reset',
			       display : $('#pre_xplanetreset'),
